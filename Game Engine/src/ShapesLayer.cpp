...
namespace PrEngine {
	...
	void ShapesLayer::update()
	{
		...
		{	
			Vertex v1 = { lines[_i].p1.x , lines[_i].p1.y, 0,  lines[_i].color.x, lines[_i].color.y, lines[_i].color.z, lines[_i].color.w, 0,0,0, 0,0, 0 };
			Vertex v2 = { lines[_i].p2.x , lines[_i].p2.y, 0,  lines[_i].color.x, lines[_i].color.y, lines[_i].color.z, lines[_i].color.w, 0,0,0, 0,0, 0 };
